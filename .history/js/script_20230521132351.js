...
vscode-file://vscode-app/c:/Users/jorgp/AppData/Local/Programs/Microsoft%20VS%20Code/resources/app/out/vs/code/electron-sandbox/workbench/workbench.html}

//pontuacao
const updateScore = () => {
    const currentTime = new Data().getTime();
    const elapsedTime = Math.floor((currentTime - startTime) / 1000);
    const score = (elapsedTime * pointPerSecond) + currentScore;
