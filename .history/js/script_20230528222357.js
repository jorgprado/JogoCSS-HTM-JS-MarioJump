...
const animationDuration = (1.5 - Math.floor(score / 100) * 0.1).toFixed
function updatePipeAnimationSpeed(score) {
  const animationDuration = 1.5 - (Math.floor(score/100) * 0.1).toFixed(2);

  pipe.style.animationDuration = `${animationDuration}s`;
}
// Atualiza o score
function updateScore() {
  if (!isGameOver) {
    ...
    updatePipeAnimationSpeed(currentScore);
