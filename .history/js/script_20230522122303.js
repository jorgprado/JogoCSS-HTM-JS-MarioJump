...
const checkCollision = () => {
    ...
    if (pipePosition <= 120 && pipePosition > 0 && marioPosition < 80){
        ...
        gameOver();
        isCollision = true;
    }  else if( pipePosition <= 0 && marioPosition >= 80 && !isPipePassed){ //caso o mario pule o tudo adicao de pontuacao +10
        incrementPipeScore();
    }
};
...
const restartGame = (event) =>{
    ...
    if (event.key === 88){ // codigo da tecla X no teclado numero
